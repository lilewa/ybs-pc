/*********************************************
 *                                           *
 * Modified from Microsoft SqlHelper class   *
 *                                           *
 * Author: Sunheart                          *
...
namespace tms.DataAccess
{
	...
	public sealed class OracleHelper
	{
		...
		/// 本地数据库连接字符串
		/// </summary>
		public static string LocalConnectionString  = ConfigurationSettings.AppSettings["LocalConnectionString"];
        ...
        static OracleHelper()
        {
            string path = ConfigurationSettings.AppSettings["XmlPath"] + "\\dataAccess.xml";
           // string path = "..\\dataAccess.xml";
            dataAccessXml = new XmlDocument();
            dataAccessXml.Load(path);
